...
// Definindo as imagens dos ícones
...
// Carrega os itens na tela do localStorage
loadItens();
...
// Adição de uma nova tarefa quando clicamos no botão +
...
// Adição de uma nova tarefa quando damos enter
...
/* Função que adiciona um item a lista de tarefas adicionando também
 os seus respectivos botões */
...
// Função que remove um item da lista de tarefas
function removeItem() {
...
// Função que coloca uma tarefa na lista de tarefas completas
...
// Função que atualiza o localStorage com as ações realizadas na tela
